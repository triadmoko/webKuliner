							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<input type="text" class="form-control" id="namaRM" name="namaRM" placeholder="Nama Rumah Makan" required data-error="Silahkan masukkan Nama Rumah Makan" autocomplete>
								...
								<div class="col-md-12">
									<div class="form-group">
										<input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat Rumah Makan" required data-error="Silahkan masukkan alamat rumah makan" autocomplete>
										<div class="help-block with-errors"></div>
									</div>
								</div>
